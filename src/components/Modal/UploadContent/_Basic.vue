      ...
      <Form :model="formState" layout="vertical" ref="formRef">
        ...
        <div class="flex gap-x-3">
          <div class="flex-auto">
            ...
            >
              <Upload
                v-model:file-list="formState.thumbnail"
                  ...
                  <div class="relative" @click="handleSetThumbnail(file)">
                    ...
                    <div class="absolute right-3 top-2">
                      <Tooltip :title="$t('set_thumbnail_primary')">
                        <Checkbox
                          :checked="formState.thumbnailPrimaryId === file.uid"
          ...
          <div class="max-w-[350px]">
            ...
            <MiniAudioPlayer
              ...
              :thumbnail="
                getThumbnailUrlPrimary(mediaInfo?.thumbnails ?? [], formState.thumbnailPrimaryId)
              "
